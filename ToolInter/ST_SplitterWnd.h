...
#ifndef _ST_SPLITTERWND_CTRL_
#define _ST_SPLITTERWND_CTRL_
...
class TOOLINTER_EXT_CLASS ST_SplitterWnd : public CSplitterWnd  
{
public:
   ...
   /* support for switching views */
    int AddView(int nSide, CRuntimeClass * pViewClass, CCreateContext* pContext);
	 ...
	 CWnd * GetWndItem(int nSide,int nViewIX);
